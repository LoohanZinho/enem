                ...
                <div>
                  ...
                  <div className="relative mb-4">
                    <div className="flex items-baseline justify-center space-x-2">
                      ...
                      <span className="text-3xl font-black text-emerald-600 dark:text-emerald-400 drop-shadow-lg bg-gradient-to-r from-emerald-500 to-emerald-700 bg-clip-text text-transparent">14,99</span>
